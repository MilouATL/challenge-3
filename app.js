...
function myWindow(title, link, image, dates, price) {
  var daysToRender = dates.spanMultipleDays === true ? `start: ${dates.start.localDate}<br/>end: ${dates.end.localDate}` : `start: ${dates.start.localDate}`
  return `
  ...
  return '<div id="infowindow" class="infowindow"><h1>' + title + '</h1>';
}
